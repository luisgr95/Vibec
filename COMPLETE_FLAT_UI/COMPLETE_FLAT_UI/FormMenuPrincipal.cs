...
namespace COMPLETE_FLAT_UI
{
    public partial class FormMenuPrincipal : Form
    {
        ...
        {
            acelerometro.Form1 fav = new acelerometro.Form1();
            fav.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fav);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            base.OnPaint(e);
            ControlPaint.DrawSizeGrip(e.Graphics, Color.Empty, sizeGripRectangle);
        }
